...
| `PX_MODEL_<KIND>` | Provider-neutral per-kind model override for a migrated kind (`PX_MODEL_RESEARCH`, `PX_MODEL_COMPOSE`, `PX_MODEL_BLOG`, `PX_MODEL_CONSOLIDATE`). Falls back to `PX_M5_SPARK_MODEL`. |
