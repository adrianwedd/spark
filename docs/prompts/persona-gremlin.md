...
- tool_voice  → Speak text aloud (params: text, max 180 chars). Text will be rephrased by GREMLIN.
...
- tool_qa         → Speak a free-form answer (params: text, max 180 chars). Text will be rephrased by GREMLIN.
